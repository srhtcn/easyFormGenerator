...
$translateProvider.translations("de", {
    ...
    "CLICK_TAP_2_OPEN"     : "klicken Sie auf Spalte zur Steuerungsauswahl öffnen",
...
$translateProvider.translations("en", {
    ...
    "CLICK_TAP_2_OPEN"     : "Click / Tap on column to open control selection",
...
$translateProvider.translations("es", {
    ...
    "CLICK_TAP_2_OPEN"     : "Click / Toque en la columna para seleccionar controles",
...
$translateProvider.translations("fr", {
    ...
    "CLICK_TAP_2_OPEN"     : "Cliquer sur une colonne pour ouvrir le menu d'édition",
...
$translateProvider.translations("jp", {
    ...
    "CLICK_TAP_2_OPEN"     : "コントロール選択を広げるには列をクリック",
...
$translateProvider.translations("tr", {
    ...
    "CLICK_TAP_2_OPEN"     : "Form ögesi eklemek için sütunlara tıkla",
